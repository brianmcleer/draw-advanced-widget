...
Created by **Brian McLeer** (City of Grand Junction, CO) and **Jeffrey Thompson** (City of Arlington, TX), building on contributions from Robert Scheitlin, Adrien Hoff, Mattias Ekstr̦m, J̩r̫me Ray, and Nicholas Cramer. Thanks to the Esri Experience Builder community for feedback and testing.